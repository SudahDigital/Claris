    ...
    <div class="col-3">
        <div class="float-left">
            <div class="text-left">
                ...
                <input type="hidden" id="{{$val_c->product_id}}" value="{{$val_c->mount}}">
                <input type="hidden" id="harga_m{{$val_c->product_id}}" value="{{$amount}}">
                <input type="hidden" id="harga{{$val_c->product_id}}" value="{{$val_c->product_harga}}">
                <input type="hidden" id="product_id_{{$val_c->product_id}}" value="{{$val_c->product_id}}">
            </div>
        </div>
    </div>
    <div class="col-4">
...
@endforeach
<input type="hidden" id="tot_hrg" name="tot_hrg" value="{{$total_hrg}}">