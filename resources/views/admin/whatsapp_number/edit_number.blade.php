...
<section class="content">
   <form method="post" action="{{route('edit_area_number')}}">
        @csrf
                ...
                <div class="card mx-auto cart_card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" required="true" name="area_name" class="form-control" placeholder="Area Name" id="area_name"required autofocus autocomplete="off" value="{{ $area_name }}">
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="form-line">
                                <div class="input-group">
                                    ...
                                    <input type="text" required="true" name="area_number" class="form-control" placeholder="81111111xxx" maxlength="12" id="area_number"required onkeyup="onlyNumber(this.value)" value="{{ $area_number }}">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select multiple class="form-control" required="true"  name="area[]"  id="area[]" required autofocus autocomplete="off" style="height: 250px;">
                              @foreach($cities as $key => $value)
                                <option value="{{ $value->id }}" <?php if ($value->area_id == $id){echo "selected";} ?>>{{ $value->id }} - {{ $value->city_name }}</option>
                              @endforeach
                            </select>
                        </div>
                    </div>
