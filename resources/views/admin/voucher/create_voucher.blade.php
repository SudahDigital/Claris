...
<section class="content">
   <form method="post" action="{{route('input_voucher')}}">
        @csrf
                    ...
                    <div class="card-body col-md-12 row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" required="true" name="code_voucher" class="form-control" id="code_voucher"required autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="produk_nama">Voucher Name <span style="color: red;">*</span></label>
                                <input type="text" required="true" name="name_voucher" class="form-control" id="name_voucher"required autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="produk_nama">Voucher Description <span style="color: red;">*</span></label>
                                <textarea type="text" name="desc_voucher" class="form-control" id="desc_voucher" cols="10" rows="5" required></textarea>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                  <input class="custom-control-input" type="radio" id="percentage" name="type" value="1" checked>
                                  <label for="percentage" class="custom-control-label">Percentage (%)</label>
                                </div>
                                <div class="custom-control custom-radio">
                                  <input class="custom-control-input" type="radio" id="flat" name="type" value="2">
                                  <label for="flat" class="custom-control-label">Flat</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="produk_nama">Amount <span style="color: red;">*</span></label>
                                <input type="text" required="true" name="amount_voucher" class="form-control" id="amount_voucher"required autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="produk_nama">Expired Date Voucher <span style="color: red;">*</span></label>
                                <div class="input-group">
                                    <input type="text" id="exp_date" name="exp_date" placeholder="dd/mm/yyyy" class="form-control date" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" required="true" name="max_use" class="form-control" id="max_use"required autofocus autocomplete="off">
                            </div>
                        </div>
                    </div>
