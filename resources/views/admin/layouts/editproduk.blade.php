                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                              ...
                              <!-- <select class="form-control" required="true"  name="kat_produk"  id="kat_produk" required autofocus autocomplete="off">
                                <option value="">--</option>
                                <option value="1" selected="{{ $produk_kategori==1 ? true : false }}">1 - Daging</option>
                                <option value="2" selected="{{ $produk_kategori==2 ? true : false }}">2 - Frozen Food</option>
                                <option value="3" selected="{{ $produk_kategori==3 ? true : false }}">3 - Buah</option>
                              </select> -->
                              <select class="form-control" required="true"  name="kat_produk"  id="kat_produk" required autofocus autocomplete="off">
                                <option value="">--</option>
