                ...
                <div class="card mx-auto cart_card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                              <div class="custom-file">
                                  <!-- <input type="file" class="custom-file-input" name="upl_image" id="upl_image" required autofocus autocomplete="off">
                                  <label class="custom-file-label" for="upl_image">Pilih Gambar</label> -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required="true" name="produk_nama" class="form-control" placeholder="Produk Nama" id="produk_nama"required autofocus autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="ket_produk">Keterangan Produk</label>
                            <textarea class="form-control" required="true"  name="ket_produk" rows="5" placeholder="Keterangan Produk" id="ket_produk" required autocomplete="off"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="harga_produk">Harga Produk</label>
                            <input type="number" required="true" name="harga_produk" class="form-control" placeholder="Harga Produk" id="harga_produk"required autofocus autocomplete="off">
                        </div>
                        <div class="form-group">
                            <div class="col-sm-6">
                              ...
                              <select class="form-control" required="true"  name="kat_produk"  id="kat_produk" required autofocus autocomplete="off">
                                <option value="">--</option>
                                <option value="1">1 - Daging</option>
                                <option value="2">2 - Frozen Food</option>
